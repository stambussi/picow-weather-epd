...
//       functionality.
//
// ADC pin used to measure battery voltage (UNUSED)
const uint8_t PIN_BAT_ADC  = A2; // A0 for micro-usb firebeetle
// Pins for E-Paper Driver Board
const uint8_t PIN_EPD_BUSY = 13; // og: 14
const uint8_t PIN_EPD_CS   = 9; // og: 13
const uint8_t PIN_EPD_RST  = 12; // og: 21
const uint8_t PIN_EPD_DC   = 8; // og: 22
const uint8_t PIN_EPD_SCK  = 10; // og: 18
const uint8_t PIN_EPD_MISO = 8; // unused?
const uint8_t PIN_EPD_MOSI = 11; // og: 23
const uint8_t PIN_EPD_PWR  = 36; // Irrelevant if directly connected to 3.3V
// I2C Pins used for BME280 (UNUSED)
#if BME280_PRESENT
...
const String LAT = "39.95657";
const String LON = "-75.14794";
// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "Philadelphia";
...
// Sleep duration in minutes. (aka how often the rpi will wake for an update)
