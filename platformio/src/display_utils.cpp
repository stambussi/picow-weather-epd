...
void printHeapUsage() 
{
    Serial.println("[debug] Heap Size       : "
                    + String(rp2040.getTotalHeap()) + " B");
    Serial.println("[debug] Available Heap  : "
                    + String(rp2040.getFreeHeap()) + " B");
    Serial.println("[debug] Used Heap       : "
                    + String(rp2040.getUsedHeap()) + " B");
    return;
}

/* This function sets the builtin LED to LOW
 */
